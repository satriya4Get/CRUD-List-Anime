...
<div class="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm">
        <div class="flex justify-center mb-4">
            <img alt="User icon" class="rounded-full" height="80" src="https://id.pinterest.com/pin/6051780741833859/" width="80"/>
        </div>
    ...
    <footer class="text-center mt-8 text-gray-600 text-sm">
        © 2019 NontonYuk. All Rights Reserved | Design by
        <a class="text-blue-500" href="#">MedioTerbuka</a>
    </footer>
</div>
@endsection
